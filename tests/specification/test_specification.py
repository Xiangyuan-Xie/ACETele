...
def test_parallel_gripper_distinguishes_public_and_kinematic_joint_names():
    ...
    assert gripper.joint.name == "opening"
    assert gripper.kinematic_joint_names == ("finger_left", "finger_right")
    with pytest.raises(ValueError, match="must be unique"):
        ParallelGripperSpec("arm", _joint("opening", 5), 0.5, ("finger", "finger"))
