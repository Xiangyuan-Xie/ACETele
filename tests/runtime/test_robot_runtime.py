...
from acetele.core import Backend, JointCommand, JointUnit, RobotCommand
from acetele.hardware.smart_servos.fashionstar import FashionStarMonitorState
from acetele.hardware.smart_servos.feetech import FeetechPacketFastState
...
def test_gripper_normalized_motion_limits_are_converted_to_radians():
    ...
    runtime._raw_packet_positions[("arm", 4)] = 0.25  # noqa: SLF001
...
def test_packet_multiturn_overflow_is_rejected_before_actor_submission():
    ...
    runtime._safety.connected()  # noqa: SLF001
    runtime._safety.ready()  # noqa: SLF001
    runtime._raw_packet_positions[("arm", 0)] = (  # noqa: SLF001
