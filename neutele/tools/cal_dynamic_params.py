...
# Print results
print(f"=== Servo Physical Parameter Estimation ===")
print(f"\n--- Torque Constant (Kt) Verification ---")
print(f"1. Provided Kt: {results['kt_provided_kgcm_per_a']:.2f} kg·cm/A")
print(
    f"2. Stall-derived Kt: {results['kt_from_stall_kgcm_per_a']:.2f} kg·cm/A (Error: {results['kt_stall_error_percent']:.1f}%)"
)
print(
    f"3. Rated-derived Kt: {results['kt_from_rated_kgcm_per_a']:.2f} kg·cm/A (Error: {results['kt_rated_error_percent']:.1f}%)"
)
